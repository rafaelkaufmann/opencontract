...
import { OracleFactory } from './Oracle';
...
export class Contract {
    ...
    constructor (params = {}) {
        ...
        this.rights = params.rights || template.rights || [];

        this.signatures = params.signatures || {};

        this.registry = params.registry ? (params.registry instanceof Registry ? params.registry : new Registry(params.registry)) : null;
    ...
    initContext() {
        this.Oracle = new OracleFactory(this.registry);
    }

    async publish (registry) {
        let _registry = registry || this.registry;
        return await _registry.publish(this);
    }
