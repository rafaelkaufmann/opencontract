...
export class Registry {
    ...
    async getPartyByName (name, publicKey) {  // TODO: STUB
        return new Party({name, publicKey, registry: this});
    }

    async getRightByName (name, publicKey) {  // TODO: STUB
        return new Right({name, publicKey, registry: this});
    }
}